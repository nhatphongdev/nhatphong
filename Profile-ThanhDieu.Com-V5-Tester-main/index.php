...
<head>
    ...
    <meta name="author" content="NhatPhong">
    <meta name="keywords"
    ...
    <meta property="og:image" content="https://ibb.co/3zy8v6Y">
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://i.imgur.com/dxVZLOG.png" alt="Nhat Phong">
    ...
    <main id="td-main">
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    <img class="avatar-img" src="<?= $ThanhDieuHeader->avatar ?>?v=<?= rand(1, 999) ?>" alt="Nhat Phong">
    ...
    <div class="nk-demo-panel toggle-slide toggle-slide-right toggle-screen-any content-active" id="SettingPanel"
        ...
        <div class="nk-demo-head">
            <h6 class="mb-0">Gnof Settings</h6>
    ...
    <footer id="footer">
        <span>
            <a href="//facebok.com/nhfong.dev" target="_blank">&copy; Copyright&nbsp;NhatPhong 2024</a>
        </span>
    </footer>
    <div class="time-now" id="real-time">00:00:00</div>
    <div id="Toast">Chilling</div>
